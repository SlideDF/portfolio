            ...
            <div className='presentation-profil'>
                ...
                <div className='profil'>
                    ...
                    <div className='profil-text'>
                        ...
                        <p><strong>Développeur web</strong> en Back-End et Front-End ayant une préférence pour le Front avec <strong>React</strong> et les technologies basées sur <strong>JavaScript</strong>.</p>
